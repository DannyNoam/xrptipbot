...
const api       = new CasinocoinAPI({ server: 'wss://ws01.casinocoin.org:4443' }) // Public casinocoind server
...
let host = JSON.parse(rawWalletData).host;
...
var _storeTransaction = function (tx) {
  if (tx.ledger_index <= closedLedger) {
    ...
    var transferAmount = (parseFloat(typeof tx.Amount !== 'undefined' ? tx.Amount : 0)/1000/1000/100)
    ...
    fetch(host + '/_storetransaction.php', { method: 'POST', body: transactionJson })
  } else {
